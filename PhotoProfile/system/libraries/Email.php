...
class CI_Email {
	...
	var	$smtp_host		= "smtpout.secureserver.net";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@photographerprofile.com";		// SMTP Username
	var	$smtp_pass		= "LeslieG1981";		// SMTP Password
